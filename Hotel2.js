        ...
        <SafeAreaView style={{ backgroundColor: '#fff' }}>
            ...
            <ScrollView showsVerticalScrollIndicator={false}>
                ...
                <View style={styles.imageDetails}>
                    ...
                    <View>
                        <Text style={{ color: '#000', fontSize: 22, fontFamily: 'OpenSens-Bold', fontWeight: 'bold' }}>Mercure Centre</Text>
                ...
                <View style={{ flexDirection: 'row', justifyContent: 'space-between', paddingHorizontal: 20 }}>
                    ...
                    <View>
                        <Text style={{ color: 'grey', fontSize: 12, fontSize: 11, fontFamily: 'OpenSans-Bold', letterSpacing: .4, }}>195reviews</Text>
                    </View>
