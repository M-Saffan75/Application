...
const PopularPage2 = ({ navigation }) => {
    return (
        <SafeAreaView>
            <StatusBar translucent backgroundColor={'transparent'} />
            <ScrollView showsVerticalScrollIndicator={false}>
                <View>
                    <ImageBackground source={require('./images/hotel7.jpg')} style={{ height: 450 }} resizeMode='cover'>
                    ...
                    <View style={{ margin: 10, marginTop: 5 }}>
                        ...
                        <View style={{ flexDirection: 'row', justifyContent: 'space-between', alignItems: 'center' }}>
                                ...
                                <Text style={{ paddingVertical: 15, fontSize: 20, fontFamily: 'OpenSans-Bold', color: '#000' }}>Sea & View</Text>
                            </View>
