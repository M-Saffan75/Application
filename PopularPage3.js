...
const PopularPage3 = ({ navigation }) => {
    return (
        <SafeAreaView>
            <StatusBar translucent backgroundColor={'transparent'} />
            <ScrollView showsVerticalScrollIndicator={false}>
                <View>
                    <ImageBackground source={require('./images/hotel8.jpg')} style={{ height: 450 }} resizeMode='cover'>
                    ...
                    <View style={{ margin: 10,marginTop: 5 }}>
                        <View>
                            <View style={{ flexDirection: 'row', justifyContent: 'space-between', alignItems: 'center' }}>
                                ...
                                <Text style={{ paddingVertical: 15, fontSize: 20, fontFamily: 'OpenSans-Bold', color: '#000' }}>Comfort & Free Services</Text>
                            </View>
