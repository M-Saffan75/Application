        ...
        <SafeAreaView style={{ backgroundColor: '#fff' }}>
            ...
            <ScrollView showsVerticalScrollIndicator={false}>
                ...
                <View style={styles.imageDetails}>
                    ...
                    <View>
                        <Text style={{ color: '#000', fontSize: 22, fontFamily: 'OpenSens-Bold', fontWeight: 'bold' }}>Citizem Paris Lyon</Text>
                        <Text style={{ color: 'grey', fontSize: 14, fontFamily: 'OpenSens-Bold', letterSpacing: .6, paddingVertical: 5 }}>Hotel Des Fonataines</Text>
                    </View>
                ...
                <View style={{ flexDirection: 'row', justifyContent: 'space-between', paddingHorizontal: 20 }}>
                    ...
                    <View>
                        <Text style={{ color: 'grey', fontSize: 12, fontSize: 11, fontFamily: 'OpenSans-Bold', letterSpacing: .4, }}>267reviews</Text>
                    </View>
