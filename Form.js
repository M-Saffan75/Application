    ...
    <SafeAreaView>
      ...
      <View styles={{ backgroundColor: '#fff' }}>
        ...
        <View>
          ...
          <View>
            <Text style={{ color: 'grey', textAlign: 'center', marginTop: 40, fontFamily: 'OpenSans-Bold' }}>Don't Have an account : <Text style={{ color: '#4eb6aa', fontSize: 16 }}>Sign Up</Text> </Text>
          </View>
        </View>
