        ...
        <SafeAreaView style={{ backgroundColor: '#fff' }}>
            ...
            <ScrollView showsVerticalScrollIndicator={false}>
                ...
                <View style={styles.imageDetails}>
                    ...
                    <View>
                        <Text style={{ color: '#000', fontSize: 22, fontFamily: 'OpenSens-Bold', fontWeight: 'bold' }}>Silver Hotel & SPA</Text>
                        <Text style={{ color: 'grey', fontSize: 14, fontFamily: 'OpenSens-Bold', letterSpacing: .6, paddingVertical: 5 }}>Green Street Central District</Text>
                    </View>
                ...
                <View style={{ flexDirection: 'row', justifyContent: 'space-between', paddingHorizontal: 20 }}>
                    ...
                    <View style={{ flexDirection: 'row' }}>
                        ...
                        <FontAwesome5 name='star' color={'#ffcd3c'} size={20} />
                        <FontAwesome5 name='star' color={'#ffcd3c'} size={20} />
                        <FontAwesome5 name='star' color={'grey'} size={20} />
                        <Text style={{ marginLeft: 10, fontSize: 18, fontFamily: 'OpenSans-Bold', color: '#000' }}>4.0</Text>
                    </View>

                    <View>
                        <Text style={{ color: 'grey', fontSize: 12, fontSize: 11, fontFamily: 'OpenSans-Bold', letterSpacing: .4, }}>365reviews</Text>
                    </View>
