import { StyleSheet, ImageBackground,ScrollView,SafeAreaView, Text, View, StatusBar } from 'react-native'
import React from 'react'
import FontAwesome5 from 'react-native-vector-icons/FontAwesome5'

const PopularPage1 = ({ navigation }) => {
    return (
        <SafeAreaView>
                  <StatusBar translucent backgroundColor={'transparent'} />
            <ScrollView showsVerticalScrollIndicator={false}>
                <View>
                    <ImageBackground source={require('./images/hotel6.jpg')} style={{ height: 450 }} resizeMode='cover'>
                    ...
                    <View style={{ margin: 10,marginTop: 5 }}>
                        ...
                        <View style={{ flexDirection: 'row', justifyContent: 'space-between', alignItems: 'center' }}>
                                ...
                                <Text style={{ paddingVertical: 15, fontSize: 20, fontFamily: 'OpenSans-Bold', color: '#000' }}>Attaction & Activities</Text>
                            </View>
                         ...
                         <Text style={{ fontSize: 20, color: 'grey', fontFamily: 'OpenSans-Medium' , letterSpacing:1,}}>
                            ...
                            <View style={{backgroundColor:'#4eb6aa' , justifyContent:'center' , marginTop:30,
